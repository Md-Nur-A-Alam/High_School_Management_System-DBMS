    ...
    <div class="container my-3">
        ...
        <form method="get">
            <select name="receiver" class="col-4">
                <option value="admin" name="receiver">From Admin</option>
                <option value="student" name="receiver">From Student</option>
                <option value="teacher" name="receiver">To ME</option>
                <option value="accounts" name="receiver">From Accounts</option>
            </select>
