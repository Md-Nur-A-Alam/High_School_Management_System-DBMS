    ...
    <div class="container my-3">
        ...
        <form method="get">
            <select name="receiver" class="col-4">
                <option value="admin" name="receiver">To ME</option>
...
<script>
    function confirmDelete(uid) {
        ...
        if (result) {
            window.location.href = 'admin_notice_delete.php?deleteNID=' + uid;
        }
    }
    ...
    function downloadNotice(id) {
        ...
        xhr.open('GET', 'admin_generate_notice.php?id=' + id, true);
